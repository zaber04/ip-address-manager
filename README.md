...
To run the project, please follow the `RUN_DOCKER.md` (to run using docker) or `RUN_DOCKERLESS.md` (to run without docker) file instead. This file primarily consists of the experience during the project journey.
